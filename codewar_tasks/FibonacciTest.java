...
public class FibonacciTest {
    ...
    public static void main(String[] args) {
		...
		int multiple = findMultiple(rangedArray.calculate(fibonacciNum, range));
		String m = String.format("\nMultiplication of all digits in range is %s", multiple);
    ...
    /**
     * @param rangedArray - sequence of numbers
     ...
     */
    static int findMultiple(int[] rangedArray) {
        int result = Arrays.stream(rangedArray).reduce(1,(a,b) -> a*b);
		//Stream<int[]> num = Stream.of(rangedArray);
        //Optional<Integer> result = num.reduce(1, (a, b) -> a * b);
        return result;
    }
}
